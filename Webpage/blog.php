          ...
          <div class="offcanvas-body">
              <ul id="navbar" class="navbar-nav text-uppercase justify-content-end align-items-center flex-grow-1 pe-3">
                ...
                <li class="nav-item">
                  <?php
                    if (isset($user) && $user) {
                        echo '<a class="nav-link me-4 active" href="blog.php?isLoggedIn=true&user_id=' . $user["id"] . '">blog</a>';
                    } else {
                        echo '<a class="nav-link me-4 active" href="blog.php">blog</a>';
                    }
                  ?>
                </li>
                <li class="nav-item">
    ...
    <div class="offcanvas-body">
        ...
        while($row=mysqli_fetch_assoc($result_cart)){
          ?>          
                  ...
                  <div><button type="button" class="btn btn-outline-danger btn-sm" onclick="deleteCartItem(<?php echo $row['id']; ?>)">X</button>
                  </div>
                  </div>
         <?php } ?>
