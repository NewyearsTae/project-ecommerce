...
if(isset($_GET['isLoggedIn'])){
  ...
  $isLoggedIn = $_GET['isLoggedIn'];
    ...
    $sql = "SELECT orderhistory.order_id, user.u_fullname, SUM(product.price) AS total_price
            FROM orderhistory
...
<div class="historybg">
    ...
    <div class="toppichis" ><h1>Orders History</h1></div>
    ...
    <!-- item1 -->
        ...
        while ($row = mysqli_fetch_assoc($result)) {
          ...
          echo '<a href="Trackingpage.php?order_id=' . $row['order_id'] . '&user_id=' . $user_id . '&isLoggedIn=true#tracking-page" class="tracking-link">';
          ...
          echo 'OrderNo. <p>' . $orderNumber . '</p>';
          
          echo '</div>';
          echo '<div class="Orderno" style="margin-right:8% ;">';
          echo 'Total Price <p>' . $row['total_price'] . '</p>';
