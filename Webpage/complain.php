...
<body data-bs-spy="scroll" data-bs-target="#navbar" data-bs-root-margin="0px 0px -40%" data-bs-smooth-scroll="true"
  ...
  <!-- testtt11111 -->
  <form id="complainForm" action="xcomplain.php" method="post" enctype="multipart/form-data">
    <div class="toppiccp" >
      <h2>Complain</h2>
      <h3>Orders ID: <?php  echo $order_id;?></h3>
    </div>
    <div class="pagebg">
      <h5 style="color: rgb(121, 121, 121); margin-left: 20px;">Tell the mistake that happened.</h5>
      <div class="cpcontent">
      <div class="mb-3">
      <label for="exampleFormControlTextarea1" class="form-label"></label>
        <textarea class="form-control" id="exampleFormControlTextarea1" name="description" rows="10"
          style="width: 90%; height:15vw; padding: 10px; border-radius: 20px; margin-left: 4%;">
        </textarea>
    </div>
    ...
    <div class="rightzone">
      ...
      <input type="file" class="form-control" id="complain" name="complain" style="display: none" accept="image/*" onchange="previewReceipt('complain', 'imagePreviewContainer_main', 'selectedFileNames_main')">
        <label for="complain" class="btn btn-primary">Upload</label>
