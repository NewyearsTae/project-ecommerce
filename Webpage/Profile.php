...
<html>
  ...
  <body data-bs-spy="scroll" data-bs-target="#navbar" data-bs-root-margin="0px 0px -40%" data-bs-smooth-scroll="true" tabindex="0">
    ...
    <form method="post" action="Profile.php?user_id=<?php echo $user["id"]; ?>">
      <div class="row">
        <div class="col-md-3 border-right">
            <div class="d-flex flex-column align-items-center text-center p-3 py-5"><img class="rounded-circle mt-5" width="150px" src="https://st3.depositphotos.com/15648834/17930/v/600/depositphotos_179308454-stock-illustration-unknown-person-silhouette-glasses-profile.jpg"><span class="font-weight-bold"><?php echo $row1["u_fullname"]; ?></span></div>
        </div>
        <div class="col-md-5 border-right">
            <div class="p-3 py-5">
                ...
                <label for="floatingText">Email</label>
                  <input type="text" class="form-control" id="u_fullname" name="u_fullname" placeholder="email" value="<?php echo $row1["email"]; ?>"disabled>
                      <?php
                ...
                <label for="floatingText">Name</label>
                  <input type="text" class="form-control" id="u_fullname" name="u_fullname" placeholder="ชื่อ - สกุล" value="<?php echo $row1["u_fullname"]; ?>"disabled>
                      <?php
                        if (isset($errors) && in_array("Please fill Fullname", $errors)) {
                            echo "<div class='alert alert-danger small-alert'>Please fill Fullname</div>";
                        }
                ...
                <div class="row mt-3">
                  ...
                  <input type="text" class="form-control" id="u_address" name="u_address" placeholder="ที่อยู่" value="<?php echo $row1["u_address"]; ?>"disabled>
                </div>
                <div class="row mt-3">
                  <label for="floatingText">Phonenumber</label>
                  <input type="text" class="form-control" id="Phonenumber" name="Phonenumber" placeholder="เบอร์โทรศัพท์" value="<?php echo $row1["Phonenumber"]; ?>"disabled>
                </div>
                <div class="mt-5 text-center">
                  <a href="editprofile.php?isLoggedIn=true&user_id=<?php echo $user_id; ?>" class="btn btn-primary profile-button">Edit Profile</a>
              </div>
            </div>
        </div>
      </div>
