        ...
        <div class="col-md-5 border-right">
            <div class="p-3 py-5">
                ...
                <label for="floatingText">Name</label>
                  <input type="text" class="form-control" id="u_fullname" name="u_fullname" placeholder="ชื่อ - สกุล" value="<?php echo $row1["u_fullname"]; ?>">
                      <?php
                ...
                <div class="row mt-3">
                  ...
                  <input type="text" class="form-control" id="u_address" name="u_address" placeholder="ที่อยู่" value="<?php echo $row1["u_address"]; ?>">
                </div>
                <div class="row mt-3">
                  <label for="floatingText">Phonenumber</label>
                  <input type="text" class="form-control" id="Phonenumber" name="Phonenumber" placeholder="เบอร์โทรศัพท์" value="<?php echo $row1["Phonenumber"]; ?>">
                </div>
