...
<html>
  ...
  <body data-bs-spy="scroll" data-bs-target="#navbar" data-bs-root-margin="0px 0px -40%" data-bs-smooth-scroll="true" tabindex="0">
      ...
      <div class="container">
        <div class="row">
          <div class="display-header d-flex justify-content-between pb-3">
            <h2 class="display-7 text-dark text-uppercase">NEW Shirt</h2>
            <div class="btn-right">
              ...
              <div class="swiper-slide">
                <div class="product-card position-relative">
                  ...
                  <div class="card-detail d-flex justify-content-between align-items-baseline pt-3">
                    ...
                    <span class="item-price text-primary">500 THB</span>
                  </div>
                </div>
              </div>
              <div class="swiper-slide">
    ...
    <div id="productlist" class="productshow">
    <?php
     $product_ids_in_cart = [];
     if ($user_id) {
         $sql_cart2 = "SELECT product_id FROM cart WHERE user_id = '$user_id'";
         $result_cart2 = mysqli_query($objCon, $sql_cart2);
         if ($result_cart2 && mysqli_num_rows($result_cart2) > 0) {
             while ($row_cart2 = mysqli_fetch_assoc($result_cart2)) {
                 $product_ids_in_cart[] = $row_cart2["product_id"];
             }
         }
     }
 
     // คำสั่ง SQL เพื่อดึงข้อมูลสินค้าทั้งหมดจากตาราง product ที่ num = 0
     $sql = "SELECT * FROM product WHERE num = 0";
     $result = mysqli_query($objCon, $sql);
     ...
     if (mysqli_num_rows($result) > 0) {
         ...
         while ($row = mysqli_fetch_assoc($result)) {
             if (!in_array($row["id"], $product_ids_in_cart)) {
                 echo '<div class="product-item" data-product-id="' . $row["id"] . '">';
                 if(isset($user_id) && !empty($user_id)) {
                     echo '<a href="ShirtWeb.php?id=' . $row["id"] . '&user_id=' . $user_id . '&isLoggedIn=' . $isLoggedIn . '">';
                 } else {
                     echo '<a href="ShirtWeb.php?id=' . $row["id"] . '">';
                 }
                 echo '<img class="imgproduct" src="/BackWeb/upload/' . $row["img"] . '">';
                 echo '<div class="product-info">';
                 echo '<h5 class="card-title text-uppercase">' . $row["name"] . '</h5>';
                 echo '<h5 class="item-price text-primary">' . $row["price"] . ' THB</h5>';
                 echo '</div>';
                 echo '</a>'; // ปิดลิงก์
                 echo '</div>';
             }
         }
     } // ถ้าไม่มีข้อมูล หรือมีข้อมูลน้อยกว่าหรือเท่ากับ 0 ไม่ต้องมีการแจ้งเตือน
                ...
                <div class="footer-menu">
                  ...
                  <div class="social-links">
                    <ul class="d-flex list-unstyled">
                      <li>
                        <a href="https://web.facebook.com/nuttakarn.puengpai.7">
                          <svg class="facebook">
                      ...
                      <li>
                        <a href="https://www.instagram.com/ntkk_ball/">
                          <svg class="instagram">
              ...
              <div class="col-lg-2 col-sm-6 pb-3">
                <div class="footer-menu text-uppercase">
                  ...
                  <ul class="menu-list list-unstyled text-uppercase">
                    ...
                    <li class="menu-item pb-2">
                      <a href="#mobile-products">Shop</a>
                    </li>
                    <li class="menu-item pb-2">
                      <?php
                      if (isset($user) && $user) {
                          echo '<a href="blog.php?isLoggedIn=true&user_id=' . $user["id"] . '">blog</a>';
                      } else {
                    ...
                    <li class="menu-item pb-2">
                      <?php
                      if (isset($user) && $user) {
                          echo '<a href="Contact.php?isLoggedIn=true&user_id=' . $user["id"] . '">Contact</a>';
                      } else {
              ...
              <div class="col-lg-3 col-sm-6 pb-3">
                <div class="footer-menu contact-item">
                  ...
                  <p>Do you have any queries or suggestions? 
                    <a href="mailto:">nuttakarn4210@gmail.com</a>
                  </p>
                  <p>If you need support? Just give us a call. 
                    <a href="">+00 000 000 000 00</a>
                  </p>
                </div>
              </div>
            </div>
