...
<html>
            ...
            <div class="offcanvas-body">
              <ul id="navbar" class="navbar-nav text-uppercase justify-content-end align-items-center flex-grow-1 pe-3">
                ...
                <li class="nav-item">
                  <?php
                    if (isset($user) && $user) {
                        echo '<a class="nav-link me-4 active" href="Contact.php?isLoggedIn=true&user_id=' . $user["id"] . '">Contact</a>';
                    } else {
                        echo '<a class="nav-link me-4 active" href="Contact.php">Contact</a>';
                    }
                  ?>
                </li>
                <li class="nav-item">
  ...
  <div class="contantct">
    ...
    <div class="iconct">
      ...
      <img class="imgicon" src="images/icon/Instagram_icon.png" class="logo">
        </a>
    </div> 
      <div class="icon2">
      <a href="https://web.facebook.com/nuttakarn.puengpai.7">
      <img class="imgicon" src="images/icon/124010.png" class="logo">
      </a>
    </div>
      <div class="icon3">
      <a href="mailto:nuttakarn4210@gmail.com">
      <img class="imgicon" src="images/icon/Gmail_icon_(2020).svg.png" class="logo">
      </a>
    </div>
    </div>
  </div>
