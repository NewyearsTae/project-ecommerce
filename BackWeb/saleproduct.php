...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    // รับค่า Sale จากฟอร์ม
    $sale = $_POST["Sale"];
    $lot = $_POST["lot"];

    // อัปเดตข้อมูล Sale ลงในฐานข้อมูล
    $sql = "UPDATE product SET sale = '$sale' WHERE id = '$id'";
    $result = mysqli_query($objCon, $sql);

    if ($result) {
        // หากอัปเดตข้อมูลสำเร็จ ให้ redirect ไปยังหน้า product.php
        header("location: lotshowtest.php?lot=" . $lot);
        exit(); // ออกจากสคริปต์เพื่อป้องกันการดำเนินการต่อ
    } else {
...
<body>
    <div class="">
        ...
        <div class="content">
            ...
            <!-- Navbar End -->
        <form method="post" action="saleproduct.php?user_id=<?php echo $id; ?>">
            <div class="bgeditmain">
                ...
                <div class="form-floating mb-3">
                    <input type="number" class="form-control" id="Sale" name="Sale" placeholder="Sale">   
