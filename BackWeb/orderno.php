...
$sql = "SELECT order_line.product_id, product.name, product.description, product.price, product.size, orders.order_id
        FROM order_line
        INNER JOIN product ON order_line.product_id = product.id
        INNER JOIN orders ON order_line.order_id = orders.order_id
        WHERE order_line.order_id = $id";
$result_1 = mysqli_query($objCon, $sql);
?>
<!DOCTYPE html>
<html lang="en">
...
<body>
        ...
        <div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-light navbar-light">
                ...
                <div class="navbar-nav w-100">
                    ...
                    <a href="order.php" class="nav-item nav-link active"><i class="fa fa-shopping-cart me-2"></i>Order</a>
                ...
                <div class="row g-4">
                    <div class="col-sm-6 col-xl-3">
                        <div class="bg-light rounded d-flex align-items-center justify-content-between p-4">
                            ...
                            <div class="ms-3">
                                <p class="mb-2">Order No</p>
                                <h6 class="mb-0"><?php echo $row['order_id'] ?></h6>
                            </div>
                        </div>
                    </div>
                    <div class="col-sm-6 col-xl-3">
                        <div class="bg-light rounded d-flex align-items-center justify-content-between p-4">
                            ...
                            <div class="ms-3">
                                ...
                                <h6 class="mb-0"><?php echo $row['total_price'] ?></h6>
                            </div>
                        </div>
                    </div>
                    <div class="col-sm-6 col-xl-3">
                        <div class="bg-light rounded d-flex align-items-center justify-content-between p-4">
                            <i class="fa fa-dollar-sign fa-3x text-primary"></i>
                            <div class="ms-3">
                                <p class="mb-2">Orderer</p>
                                <h6 class="mb-0"><?php echo $row['u_fullname'] ?></h6>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="container-fluid pt-4 px-4">
                <div class="bg-light text-center rounded p-4">
                    ...
                    <div class="d-flex align-items-center justify-content-between mb-4">
                        ...
                        <div>
                            <a href="confirm_order.php?order_id=<?php echo $row["order_id"]; ?>" class="btn btn-success me-2" onclick="openReceiptPage(<?php echo $row["order_id"]; ?>)">Confirm Order</a>
                            <a href="delorder.php?order_id=<?php echo $row["order_id"]; ?>" class="btn btn-danger">DELETE</a>
                        </div>
                    </div>
                    <table class="table text-start align-middle table-bordered table-hover mb-0">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td>
                                    <a href="viewimgO.php?order_id=<?php echo $row["order_id"]; ?>&product_id=<?php echo $row["product_id"]; ?>" class="btn btn-info">View Images</a>
                                </td>
    ...
    <script>
    function openReceiptPage(order_id) {
        // เปิดหน้า Ordersreceipt.php ในหน้าต่างใหม่
        window.open("Ordersreceipt.php?order_id=" + order_id, "_blank");
    }
    </script>
