...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql_product = "INSERT INTO lot (price,lot) VALUES ('$price','$lot')";
    ...
    <div class="">
        ...
        <form method="post" action="addlot.php">
            <div class="bgeditmain">
                ...
                <div class="form-floating mb-3">
                    <input type="number" class="form-control" id="price" name="price" placeholder="Price" required onblur="formatPrice(this)">
