...
$sql = "SELECT * FROM complain WHERE num = 0";
$result = mysqli_query($objCon, $sql);
$total_complain_num_zero = mysqli_num_rows($result);

$sql = "SELECT complain.*, user.u_fullname, SUM(orderhistory.price) AS total_price
        FROM complain
        ...
        ORDER BY complain.created_at DESC"; // เพิ่ม ORDER BY เพื่อเรียงตามวันที่สร้างล่าสุดก่อน
$result = mysqli_query($objCon, $sql);
            ...
            <nav class="navbar bg-light navbar-light">
                ...
                <div class="navbar-nav w-100">
                    ...
                    <a href="history.php" class="nav-item nav-link"><i class="fa fa-history me-2"></i>Purchase
                        History</a>
                    <a href="reportpage.php" class="nav-item nav-link active"><i
                    ...
                    <div class="table-responsive">
                        <table class="table text-start align-middle table-bordered table-hover mb-0">
                            ...
                            <?php while ($row = mysqli_fetch_assoc($result)) {
                                ...
                                // เพิ่มเงื่อนไขเช็คค่า num เป็น 0 ก่อนที่จะแสดงข้อมูล
                                if ($row['num'] == 0) { ?>
                                    <tr>
                                        ...
                                        <td><a href="UserReport.php?complain_id=<?php echo $row["complain_id"] ?>" class="btn btn-primary">Show</a></td>
                                    </tr>
                                <?php }
                            } ?>
                            </tbody>
