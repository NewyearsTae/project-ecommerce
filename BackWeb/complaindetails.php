...
$sql = "SELECT * FROM complaindetails";
$result = mysqli_query($objCon, $sql);
$total_complain_num_zero = mysqli_num_rows($result);

$sql = "SELECT complaindetails.*, user.u_fullname, SUM(orderhistory.price) AS total_price
        FROM complaindetails
        INNER JOIN user ON complaindetails.user_id = user.u_id
        INNER JOIN orderhistory ON complaindetails.order_id = orderhistory.order_id
        GROUP BY complaindetails.complain_id, user.u_fullname
        ORDER BY complaindetails.created_at DESC"; // เพิ่ม ORDER BY เพื่อเรียงตามวันที่สร้างล่าสุดก่อน
$result = mysqli_query($objCon, $sql);
        ...
        <div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-light navbar-light">
                ...
                <div class="navbar-nav w-100">
                    ...
                    <a href="complaindetails.php" class="nav-item nav-link active"><i
                            ...
                            <tbody>
                                <?php while ($row = mysqli_fetch_assoc($result)) {
                                    ...
                                    <tr>
                                        ...
                                        <td><a href="UserReport2.php?complain_id=<?php echo $row["complain_id"] ?>"
