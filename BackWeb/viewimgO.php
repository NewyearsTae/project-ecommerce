...
// ดึง product_id จากตาราง order_line โดยใช้ order_id
$sql_product_id = "SELECT product_id FROM order_line WHERE order_id = '$order_id'";
$result_product_id = mysqli_query($objCon, $sql_product_id);

// ใช้ product_id ที่ได้จาก order_line เพื่อดึงข้อมูลภาพสินค้าจากตาราง product_img
$sql_img = "SELECT * FROM product_img WHERE product_id = '$product_id'";
$result_img = mysqli_query($objCon, $sql_img);

$sql_img2 = "SELECT img FROM product WHERE id = '$product_id'";
$result_img2 = mysqli_query($objCon, $sql_img2);
$row2 = mysqli_fetch_assoc($result_img2);
    ...
    <div class="">
        ...
        <div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-light navbar-light">
                ...
                <div class="navbar-nav w-100">
                    ...
                    <a href="product.php" class="nav-item nav-link"><i class="fa fa-box-open me-2"></i>Product</a>
                    ...
                    <a href="history.php" class="nav-item nav-link"><i class="fa fa-history me-2"></i>Purchase
                        History</a>
                    <a href="income.php" class="nav-item nav-link"><i class="fa fa-dollar-sign me-2"></i>Income</a>
        ...
        <form method="post" action="addlot.php">
            <div class="bgeditmain">
                ...
                <br>
                <div class="mb-3">
                    <img src="upload/<?php echo $row2['img']; ?>" alt="Product Image" style="max-width: 100%; max-height: 200px; margin-bottom: 10px;">
                    ...
                    <a href="orderno.php?order_id=<?php echo $order_id ?>" class="w-100 btn btn-lg btn-primary">Back</a>
                </div>
                </div>            
            </div>
        </form>
